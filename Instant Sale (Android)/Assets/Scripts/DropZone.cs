    ...
    public void OnDrop(PointerEventData eventData){
        ...
        if (d != null){
            ...
            if (transform.childCount == 2 && d.parentToReturnTo != transform){ //Check there isn't already a property in the slot
                ...
                buttonImage2.sprite = (card2.GetComponent<Card>().tenants) ? gameManager.normal : gameManager.warning;
                ...
                GetComponent<BuyPanel>().openPropertySlotButton.GetComponent<Image>().sprite = gameManager.warning;
            ...
            buttonImage.sprite = (c.tenants) ? gameManager.normal : gameManager.warning;
